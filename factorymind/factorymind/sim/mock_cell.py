"""C2 — Sim state schema and mock cell environment."""
...
PartLocation = str  # bin_a | station_1 | gripper_0 | gripper_1 | ...
...
# Named targets → pose labels (precomputed lookup; MuJoCo will use joint goals later)
...
class MockCellEnv:
    ...
    Swap this for a MuJoCo-backed env once the MJCF scene is ready.
    """
